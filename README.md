...
```bash
git clone https://github.com/Frederic-Rodrigues/minimal-linux.git && cd minimal-linux && chmod +x setup_vm.sh && ./setup_vm.sh
```
...
- **Gemini Code Assist** - Official genai companion for vscode
- **tools** - python3-pip, npm, build-essential, etc.
